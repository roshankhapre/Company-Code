...
const Carousel = () => {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-gray-900">
      <div
        className={`absolute inset-0 flex items-center justify-center flex-col h-full transition-transform duration-1000 ease-in-out ${
      ...
      >
        ...
        <h2 className="absolute bottom-12 text-white text-3xl sm:text-4xl md:text-5xl font-bold text-center px-4 transition-opacity duration-1000 ease-in-out">
          {texts[currentIndex]}
        </h2>
      </div>
